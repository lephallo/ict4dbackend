...
// Neon.tech database connection (hardcoded or via environment variable)
const pool = new Pool({
  connectionString: "postgresql://neondb_owner:npg_MPhNtOYqvV83@ep-blue-silence-adlk5oj3-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
